    ...
    render() { 
        return (        
            <div className="dashboard">
                ...
                <Content>
                    <div className="row">
                        <ValueBox cols="12 6 4 4" color="green" icon="bank" text="Total de crédito" value="20,00"/>
                        <ValueBox cols="12 6 4 4" color="red" icon="credit-card" text="Total de dédito" value="10,00"/>
